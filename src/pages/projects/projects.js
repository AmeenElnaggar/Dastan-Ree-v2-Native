...
document.addEventListener('DOMContentLoaded', () => {
  ...
  renderPageHeader('#page-header-root', {
    title: 'Our Projects',
    subtitle: 'Explore our full portfolio of residential and commercial developments.',
    breadcrumbs: [{ label: 'Home', href: '../home/index.html' }, { label: 'Projects' }],
  });
...
function getFiltered() {
  let list = activeType === 'all' ? [...projects] : projects.filter(p => p.type === activeType);
