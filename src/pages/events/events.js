...
function renderHeader(selector) {
  ...
  const totalYears = new Set(
    events.map((e) => parseDate(e.date)?.getFullYear()).filter(Boolean),
  ).size;
      ...
      <div class="page-header__inner">
        <div class="page-header__content">
          <nav class="page-header__breadcrumb" aria-label="Breadcrumb">
            ...
            <span class="page-header__crumb page-header__crumb--active">Events &amp; Happenings</span>
          </nav>
          <h1 class="page-header__title">Events &amp; Happenings</h1>
          <p class="page-header__subtitle">Launches, open houses, seminars and webinars — where Dastan meets the community</p>
        </div>
        <div class="page-header__stats">
          <div class="page-header__stat">
            <span class="page-header__stat-value">${totalEvents}+</span>
            <span class="page-header__stat-label">Events</span>
          </div>
...
function renderEvents() {
  ...
  pageItems.forEach((e) => {
    ...
    div.innerHTML = renderEventCard(e);
    fragment.appendChild(div.firstElementChild);
  });
  grid.appendChild(fragment);

  countEl.innerHTML = `Showing <strong>${total}</strong> event${total !== 1 ? "s" : ""}`;
